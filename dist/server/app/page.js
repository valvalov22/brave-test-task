...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 3428)), "E:\\prog\\braved-test\\app\\page.tsx"],
          metadata: {
    ...
    const pages = ["E:\\prog\\braved-test\\app\\page.tsx"];
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 5601))
...
const Cards = styled_components_cjs/* styled */.zo.div`
  display: flex;
...
`;
const Main = styled_components_cjs/* styled */.zo.main`
  width: 90%;
  margin: 0 auto;
...
`;
const Card = styled_components_cjs/* styled */.zo.div`
  display: flex;
...
`;
const CardName = styled_components_cjs/* styled */.zo.div`
  margin-top: 1em;
  font-size: 18px;
  text-align: center;
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`E:\prog\braved-test\app\page.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [381,490,285], () => (__webpack_exec__(5818)));
